...
const Users: React.FC = () => {
  ...
  return (
    <div className="p-6 lg:p-8">
      ...
      <div className="mb-6">
        <h1 className="text-[28px] font-bold text-[#111111] leading-tight" style={{ fontFamily: 'Roboto, sans-serif' }}>Người dùng</h1>
              ...
              {loading ? <SkeletonRow /> : users.length === 0 ? (
                <tr><td colSpan={4} className="text-center py-16">
                  <div className="flex flex-col items-center gap-3 text-[#767676]">
                    ...
                    <p className="text-[14px]" style={{ fontFamily: 'Roboto, sans-serif' }}>Không tìm thấy người dùng nào</p>
                  </div>
                </td></tr>
              ) : users.map(u => (
                <tr key={u._id} className="border-b border-[#DFDFDF] hover:bg-[#F5F5F5] transition-colors">
                  ...
                  <td className="px-4 py-3 text-[14px] text-[#484848]" style={{ fontFamily: 'Roboto, sans-serif' }}>
                    {u.email}
                  </td>
                  <td className="px-4 py-3">
                    <select
